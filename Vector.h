...
public:
  Vector(unsigned long bufferReserve = 5) : m_buffer_size(bufferReserve), m_buff_preinit(bufferReserve), m_data_amount(0x00) { _alloc_(); }
...
public:
   ...
   */
  unsigned long getSize() const { return m_data_amount; }

  /**
   * @return Returns the size of the buffer.
   */
  unsigned long getContainerSize() const { return m_buffer_size; }
   ...
   */
  T &getFirst() const { return _get_(0); }

  /**
   * @return Returns the last element.
   */
  T &getLast() const { return _get_(m_data_amount - 0x01); }
